...
#define NVIC_PriorityGroup_0     (0x0700U) /* 0 bits for pre-emption priority 3 bits for subpriority */
#define NVIC_PriorityGroup_1     (0x0600U) /* 1 bits for pre-emption priority 2 bits for subpriority */
#define NVIC_PriorityGroup_2     (0x0500U) /* 2 bits for pre-emption priority 1 bits for subpriority */
#define NVIC_PriorityGroup_3     (0x0400U) /* 3 bits for pre-emption priority 0 bits for subpriority */
