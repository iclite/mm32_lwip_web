...
typedef enum {
    MM32_BSP_LED_STATUS_OFF,
    MM32_BSP_LED_STATUS_ON,
} MM32_BSP_LED_STATUS;

typedef enum {
    MM32_BSP_LED_COLOR_RED,
    MM32_BSP_LED_COLOR_GREEN,
    MM32_BSP_LED_COLOR_BLUE,
    MM32_BSP_LED_COLOR_YELLOW,
} MM32_BSP_LED_COLOR;
...
/// @{
    ...
    #define RED_LED_STATUS      ledStatus[0]
    #define GREEN_LED_STATUS    ledStatus[1]
    #define BLUE_LED_STATUS     ledStatus[0]
    #define YELLOW_LED_STATUS   ledStatus[1]
#endif
    ...
    #define RED_LED_STATUS      ledStatus[5]
    #define GREEN_LED_STATUS    ledStatus[2]
    #define BLUE_LED_STATUS     ledStatus[3]
    #define YELLOW_LED_STATUS   ledStatus[4]
...
#define YELLOW_LED_OFF      LD4_off
    ...
    #define RED_LED_STATUS      ledStatus[0]
    #define GREEN_LED_STATUS    ledStatus[1]
    #define BLUE_LED_STATUS     ledStatus[2]
    #define YELLOW_LED_STATUS   ledStatus[3]
