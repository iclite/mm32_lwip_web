...
#pragma location=0x20018000
GLOBAL ETH_DMADESCTypeDef  DMARxDscrTab[ETH_RX_BUF_NUM];/* Ethernet Rx MA Descriptor */
#pragma location=0x20018080
GLOBAL ETH_DMADESCTypeDef  DMATxDscrTab[ETH_TX_BUF_NUM];/* Ethernet Tx DMA Descriptor */
#pragma location=0x20018100
GLOBAL uint8_t Rx_Buff[ETH_RX_BUF_NUM][ETH_RX_BUF_SIZE]; /* Ethernet Receive Buffer */
#pragma location=0x200198D0
GLOBAL uint8_t Tx_Buff[ETH_TX_BUF_NUM][ETH_TX_BUF_SIZE]; /* Ethernet Transmit Buffer */

#elif defined (__GNUC__) /*!< GNU Compiler */
GLOBAL ETH_DMADESCTypeDef  DMARxDscrTab[ETH_RX_BUF_NUM] __attribute__ ((aligned (4))); /* Ethernet Rx DMA Descriptor */
GLOBAL ETH_DMADESCTypeDef  DMATxDscrTab[ETH_TX_BUF_NUM] __attribute__ ((aligned (4))); /* Ethernet Tx DMA Descriptor */
GLOBAL uint8_t Rx_Buff[ETH_RX_BUF_NUM][ETH_RX_BUF_SIZE] __attribute__ ((aligned (4))); /* Ethernet Receive Buffer */
GLOBAL uint8_t Tx_Buff[ETH_TX_BUF_NUM][ETH_TX_BUF_SIZE] __attribute__ ((aligned (4))); /* Ethernet Transmit Buffer */
